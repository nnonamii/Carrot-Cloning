...
urlpatterns = [
    ...
    path("bump_trade/<int:pk>/", views.bump_trade, name="bump_trade"),
    ...
    path("bump_stores/<int:pk>/", views.bump_stores, name="bump_stores"),
    ...
    path("bump_realty/<int:pk>/", views.bump_realty, name="bump_realty"),
    ...
    path("bump_oldcar/<int:pk>/", views.bump_oldcar, name="bump_oldcar"),
